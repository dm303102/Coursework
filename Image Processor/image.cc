...
// Some code originally written by Tom Ruch, substantially modified by Dr. Chelberg.
// last-modified: Tue Feb  6 14:14:40 2007
...
// Auxilliary routine to clear an array.
...
//              img      - the image to return the data in.
//
...
//  Function: WritePNM
//
//  Purpose: writes a PNM image file from the array to the output stream,
//           with a comment (if provided)
//  
//  Parameters: array - pointer to the image to write
